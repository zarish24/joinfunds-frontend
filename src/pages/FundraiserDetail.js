...
const FundraiserDetail = () => {
  ...
  const maxSteps = Math.ceil(donners?.length? (donners?.length / numDonorsPerPage):0);
                    ...
                    >
                      ...
                      { donners
                        ...
                        ?.map((donor, index) => (
                          ...
                          >
                            <img
                              src={donor?.user_detail[0]?.profileImage ? donor?.user_detail[0]?.profileImage : avat5}
                              alt=""
                              style={{
                                height: 80,
                                width: 80,
                            ...
                            <Typography variant="subtitle1">
                              {donor?.user_detail[0]?.firstName} {donor?.user_detail[0]?.lastName}
                            </Typography>
                            <Typography variant="body1">${donor?.amount}</Typography>
                          </Box>
                        ))}
                    </Box>
                    </div>
                  ...
                  <div className="widget style-1 widget_avatar">
                    ...
                    </div>
                    {
                      ...
                      {topDonners?.map((item, ind) => (
                        <div className="avatar-item" key={ind}>
                          <div className="avatar-media">
                            <img src={item?.user_detail[0]?.profileImage ? item?.user_detail[0]?.profileImage : avat5 } alt="" />
                          </div>
                          <div className="avatar-info">
                            <h6 className="title">
                              <Link to={"#"}>{item?.user_detail[0]?.firstName} {item?.user_detail[0]?.lastName}</Link>
                            </h6>
                            <span className="donors-item">$ {item.amount}</span>
                          </div>
                        </div>
                      ))}
                    </div>
...
>
  ...
  <div className="input-group">
    ...
    >
      ...
      {formData.chain_id !== 0 && formData.chain_id !== 97 && formData.chain_id !== 11155111 && (
