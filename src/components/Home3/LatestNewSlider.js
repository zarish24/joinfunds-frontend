            ...
            <SwiperSlide>
              <div className="dz-card style-4 " style={{ backgroundImage: 'url(' + IMAGES.BlogGrid2 + ')' }}>
                <div className="dz-info">
                  ...
                  <p class="blogDetail">Amidst the joyous festivities and gift-giving rituals of the holiday season, it's easy to get swept away in the whirl wind of preparations</p><br/>
