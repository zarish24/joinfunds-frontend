      ...
      useEffect(() => {
        ...
        if (props?.searchText !== "") {
            const filteredProjects = popular.filter((project) =>
              project.subtitle?.toLowerCase()?.includes(props.searchText?.toLowerCase())
            );
                    ...
                    <div className="site-filters style-1 clearfix">
                        <ul className="filters justify-content-between" data-bs-toggle="buttons">
                            <li className={`btn ${activeGenre === "All" ? "active" : ""}`}>
                                ...
                                <Link to={"#"}  onClick={()=>setActiveGenre("All")}>All Projects</Link> 
                            </li>
                            <li data-filter=".Technology" className={`btn ${activeGenre === "Medical" ? "active" : ""}`}>
                                
                                <Link to={"#"}  onClick={()=>setActiveGenre("Medical")}>Medical</Link> 
                            </li>
                            <li data-filter=".Medical" className={`btn ${activeGenre === "Memorial" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Memorial")}>Memorial</Link> 
                            </li>
                            <li data-filter=".Business" className={`btn ${activeGenre === "Emergency" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Emergency")}>Emergency</Link> 
                            </li>
                            <li data-filter=".Fashion" className={`btn ${activeGenre === "Nonprofit" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Nonprofit")}>Nonprofit</Link> 
                            </li>
                            <li data-filter=".Technology" className={`btn ${activeGenre === "Education" ? "active" : ""}`}>
                                
                                <Link to={"#"}  onClick={()=>setActiveGenre("Education")}>Education</Link> 
                            </li>
                            <li data-filter=".Medical" className={`btn ${activeGenre === "Animals" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Animals")}>Animals</Link> 
                            </li>
                            <li data-filter=".Business" className={`btn ${activeGenre === "Business" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Business")}>Business</Link> 
                            </li>
                            <li data-filter=".Fashion" className={`btn ${activeGenre === "Community" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Community")}>Community</Link> 
                            </li>
                            <li data-filter=".Technology" className={`btn ${activeGenre === "Creative" ? "active" : ""}`}>
                                
                                <Link to={"#"}  onClick={()=>setActiveGenre("Creative")}>Creative</Link> 
                            </li>
                            <li data-filter=".Medical" className={`btn ${activeGenre === "Current Events" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Current Events")}>Current Events</Link> 
                            </li>
                            <li data-filter=".Business" className={`btn ${activeGenre === "Event" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Event")}>Event</Link> 
                            </li>
                            <li data-filter=".Fashion" className={`btn ${activeGenre === "Faith" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Faith")}>Faith</Link> 
                            </li>
                            <li data-filter=".Technology" className={`btn ${activeGenre === "Family" ? "active" : ""}`}>
                                
                                <Link to={"#"}  onClick={()=>setActiveGenre("Family")}>Family</Link> 
                            </li>
                            <li data-filter=".Medical" className={`btn ${activeGenre === "Sport" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Sport")}>Sport</Link> 
                            </li>
                            <li data-filter=".Business" className={`btn ${activeGenre === "Travel" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Travel")}>Travel</Link> 
                            </li>
                            <li data-filter=".Fashion" className={`btn ${activeGenre === "Veteran" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Veteran")}>Veteran</Link> 
                            </li>
                            <li data-filter=".Medical" className={`btn ${activeGenre === "Legal" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Legal")}>Legal</Link> 
                            </li>
                            <li data-filter=".Business" className={`btn ${activeGenre === "General" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("General")}>General</Link> 
                            </li>
                            <li data-filter=".Fashion" className={`btn ${activeGenre === "Mission" ? "active" : ""}`}>
                                
                                <Link to={"#"} onClick={()=>setActiveGenre("Mission")}>Mission</Link> 
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                >
                    ...
                    <AnimatePresence>
                      ...
                      >
                        ...
                        justifyContent="center"
                        alignItems="center" >
                            <Typography variant="h4">No Campaign Found Goto Prrevious Page!</Typography>
                        </Box>
                                ...
                                >
                                    ...
                                    <div className="dz-card style-2 overlay-skew">
                                        <div className="dz-media">
                                            <Link to={`/fundraiser-detail/${item._id}`}><img src={item.campaign_image} alt="" /></Link>
                                        </div>
                                        <div className="dz-info">
                                            <ul className="dz-category">
                                                <li><Link to={"#"}>{item.title}</Link></li>
                                            </ul>
                                            <h5 className="dz-title"><Link to={`/fundraiser-detail/${item._id}`}>{item.subtitle} </Link></h5>
                                            <div className="progress-bx style-1">
                                                ...
                                                <ul className="progress-tag">
                                                    ...
                                                    <li className="goal">
                                                        <i className="lar la-calendar"></i> Goal: <span className="text-primary">${item.total_funding}</span>
                                                    </li>
                                                </ul> 
                                            </div>
            ...
            <ul className="pagination">
              {Array.from({ length: props.page+1 }, (_, i) => (
                <li
                  ...
                  key={i}
                >
                  <Link to={"#"} className="page-link" onClick={() => props.setPage(i + 1)}>
                    {i + 1}
                  </Link>
                </li>
              ))}
